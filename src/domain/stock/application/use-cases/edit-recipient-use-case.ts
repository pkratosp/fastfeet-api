...
type EditRecipientUseCaseResponse = Either<Error, {
    recipient: Recipient
}>
...
export class EditRecipientUseCase {
    ...
    async execute(data: EditRecipientUseCaseRequest): Promise<EditRecipientUseCaseResponse> {
        const findRecipient = await this.recipientRepository.findByRecipient(data.cpfRecipient)
